...
import { FaLock, FaBoxOpen, FaMemory, FaCode } from "react-icons/fa";
import { MdLayers, MdCheckCircle, MdWarning } from "react-icons/md";
        ...
        <div className="flex-1 max-w-4xl">
          ...
          <section className={`mb-12 rounded-2xl p-8 border ${
            ...
            <div className="flex items-start gap-4">
              ...
              <p className="text-lg leading-relaxed">
                ...
                lexical scope, even after the outer function has returned. It's one of JavaScript's 
                most powerful and commonly misunderstood features.
              </p>
            </div>
          </section>
          ...
          <section id="what-is" className="mb-12 scroll-mt-24">
            ...
            <p className="mb-6 text-lg leading-relaxed">
              Simply put: a closure gives you access to an outer function's scope from an inner 
            ...
            <div className={`p-6 rounded-xl mb-6 ${
              ...
              <p className={`leading-relaxed mb-4 ${theme === 'light' ? 'text-neutral-700' : 'text-neutral-300'}`}>
                Imagine a backpack 🎒 that a hiker takes on a journey. Even after leaving the 
                starting point (outer function returns), the hiker still has access to everything 
                in their backpack (outer function's variables). The closure is like the backpack - 
                it carries the context with it wherever it goes!
              </p>
            </div>

            <div className={`grid md:grid-cols-3 gap-4`}>
              <div className={`flex flex-col items-center gap-3 p-5 rounded-lg text-center ${
                theme === 'light' ? 'bg-white border border-gray-300' : 'bg-gray-800 border border-gray-700'
              }`}>
...
// innerFunction still has access to outerVariable!`}</code>
              </pre>
            </div>
            ...
            <div className={`p-6 rounded-xl border mb-6 ${
              ...
              <ol className="space-y-2 ml-6 list-decimal">
                <li><strong>outerFunction</strong> creates a variable and a nested function</li>
                <li>The nested <strong>innerFunction</strong> references the outer variable</li>
                <li><strong>outerFunction</strong> returns the inner function</li>
                <li>Even after <strong>outerFunction</strong> completes, <strong>innerFunction</strong> still "remembers" outerVariable</li>
                <li>This "memory" is the closure!</li>
              </ol>
            </div>

            <h3 className="text-xl font-semibold mb-4 mt-8">Visual Representation</h3>
            
            <div className={`rounded-xl p-6 mb-6 border ${
              theme === 'light' ? 'bg-white border-gray-300' : 'bg-gray-800 border-gray-700'
            }`}>
              <div className="space-y-4">
                <div className={`p-4 rounded-lg border-blue-500 ${
                  theme === 'light' ? 'bg-blue-50' : 'bg-blue-900/20'
                }`}>
                  <div className="font-semibold mb-2"> Outer Function Scope</div>
                  <div className=" text-sm">
                    <div>• outerVariable = "I'm from outer scope!"</div>
                    <div className={`mt-3  border-green-500 `}>
                      <div className="font-semibold mb-2"> Inner Function (Closure)</div>
                      <div className=" text-sm">
          ...
          <section id="examples" className="mb-12 scroll-mt-24">
            ...
            <div className={`rounded-xl p-6 mb-6 ${
              ...
              <div className="flex items-center gap-2 mb-3">
                ...
                <span className="font-semibold text-green-500">Private Variable Pattern</span>
              </div>
              <pre className={`p-4 rounded-lg overflow-x-auto ${
                theme === 'light'
                  ? 'bg-neutral-900 text-green-400'
...
console.log(counter.count); // undefined`}</code>
              </pre>
            </div>

            <h3 className="text-2xl font-semibold mb-4 mt-8">2. Function Factory</h3>
...
// Each function "remembers" its own multiplier!`}</code>
              </pre>
            </div>

            <h3 className="text-2xl font-semibold mb-4 mt-8">3. Event Handlers with Closures</h3>
...
setupButtons();
// Each button remembers its own buttonText and index!`}</code>
              </pre>
            </div>
            ...
            <div className={`p-6 rounded-xl border ${
              ...
              <div className="flex items-center gap-2 mb-3">
                ...
                <span className="font-semibold">Common Pitfall: Loop Closures</span>
              </div>
      ...
      console.log(index); // 0, 1, 2 correctly
          ...
          <section id="use-cases" className="mb-12 scroll-mt-24">
            ...
            <div className="space-y-4">
              {[
                ...
                <div key={index} className={`flex items-start gap-4 p-5 border rounded-xl transition ${
                  theme === 'light' ? 'border-gray-400 hover:border-gray-700 hover:bg-gray-100' : 'border-gray-500 hover:border-gray-300 hover:bg-gray-800'
                }`}>
                  <span className="text-3xl flex-shrink-0 text-purple-500">{item.icon}</span>
                  <div>
            ...
            <div className={`mt-8 p-6 rounded-xl border ${
              ...
              <ul className="space-y-2 ml-8 list-disc">
                ...
                <li>They enable data privacy and encapsulation in JavaScript</li>
                <li>Every function in JavaScript creates a closure</li>
                <li>Be mindful of memory - closures keep outer variables in memory</li>
                <li>Use <code className={`px-2 py-1 rounded ${theme === 'light' ? 'bg-gray-200' : 'bg-gray-700'}`}>let</code> instead of <code className={`px-2 py-1 rounded ${theme === 'light' ? 'bg-gray-200' : 'bg-gray-700'}`}>var</code> in loops to avoid common closure pitfalls</li>
              </ul>
            </div>
          </section>
          ...
          <footer className={`pt-8 border-t text-center ${
            ...
            <p className="text-sm mb-6">
              Master closures to unlock JavaScript's full potential
            </p>
            <button
