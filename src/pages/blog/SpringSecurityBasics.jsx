...
import { TbLockCheck, TbShieldCheck, TbLockFilled, TbTargetArrow, TbWorldWww  } from "react-icons/tb";
        ...
        <div className="flex-1 max-w-4xl">
          ...
          <header className="mb-12">
            ...
            <p className={`text-xl leading-relaxed ${
              ...
              A comprehensive guide to understanding how Spring Security works and how to secure REST APIs effectively
            </p>
          </header>
          ...
          <section id="what-is" className="mb-12 scroll-mt-24">
            ...
            <p className="mb-6 text-lg leading-relaxed">
              ...
              <strong className={theme === 'light' ? 'text-purple-700' : 'text-purple-400'}> authentication</strong> and{' '}
              <strong className={theme === 'light' ? 'text-purple-700' : 'text-purple-400'}>authorization</strong>.
              Every incoming HTTP request is intercepted by a chain of security
              filters before it reaches your application logic.
            </p>

            <div className={`grid gap-4 rounded-xl p-6 `}>
              <div className={`flex items-start gap-4 p-5 rounded-full ${
          ...
          <section id="filter-chain" className="mb-12 scroll-mt-24">
            ...
            <p className="mb-6 text-lg leading-relaxed">
              ...
              filter has a specific responsibility, such as validating credentials
          ...
          <section id="rest-api" className="mb-12 scroll-mt-24">
            ...
            <p className="mb-6 text-lg leading-relaxed">
              ...
              manner. Instead of relying on server-side sessions, the client sends
              credentials or tokens with every request.
            </p>
            ...
            <div className="grid md:grid-cols-3 gap-4">
              <div className={`p-6 rounded-xl border ${
                ...
                <div className="text-3xl mb-3"><HiTicket size={30}/></div>
              ...
              <div className={`p-6 rounded-xl border ${
                ...
                <div className="text-3xl mb-3"><IoKey size = {30} /></div>
              ...
              <div className={`p-6 rounded-xl border ${
                ...
                <div className="text-3xl mb-3"><TbLockFilled size={30}/></div>
          ...
          <section id="best-practices" className="mb-12 scroll-mt-24">
            ...
            <div className="space-y-4">
              {[
                { icon: <TbLockFilled size={30}/>, text: 'Always hash passwords using BCrypt or Argon2' },
                { icon: <RiBroadcastFill size={30}/>, text: 'Prefer stateless authentication for REST APIs' },
                { icon: <TbTargetArrow size={30}/>, text: 'Protect sensitive endpoints with proper role-based access' },
                { icon: <AiOutlineStop size={30}/>, text: 'Never log credentials, tokens, or sensitive data' },
                { icon: <MdOutlineWifiProtectedSetup size={30}/>, text: 'Keep security dependencies up to date regularly' },
                { icon: <TbWorldWww size={30}/>, text: 'Use HTTPS in production environments' }
              ].map((item, index) => (
          ...
          <footer className={`pt-8 border-t text-center ${
            ...
            <p className="text-sm">
              Written for backend developers exploring Spring Security fundamentals
            </p>
            <button
