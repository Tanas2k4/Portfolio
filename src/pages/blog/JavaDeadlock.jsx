      ...
      <div className="mx-auto max-w-7xl flex flex-col lg:flex-row gap-4 lg:gap-8">
        ...
        <div className="flex-1 w-full max-w-4xl">
          <header className="mb-12">
            ...
            >
              What deadlocks are, why they happen, and how to prevent them in
              Java applications
            </p>
          </header>
          ...
          >
            <div className="flex items-start gap-4">
              ...
              <p className="text-lg leading-relaxed">
                Deadlock is one of the most critical issues in concurrent
                programming where two or more threads are blocked forever,
                waiting for each other to release resources. Understanding and
                preventing deadlocks is essential for building robust
          ...
          <section id="what-is" className="mb-12 scroll-mt-24">
            ...
            <p className="mb-6 text-lg leading-relaxed">
              A deadlock occurs when multiple threads are waiting for resources
              held by each other, creating a circular dependency. No thread can
              proceed, and the application hangs indefinitely.
            </p>
            ...
            >
              ...
              >
                Imagine two people trying to cross a narrow bridge from opposite
                sides. Person A needs to cross to the other side where Person B
                is standing, and Person B needs to cross to where Person A is
                standing. If both step onto the bridge at the same time and
                refuse to step back, neither can proceed - this is a deadlock!
              </p>
            </div>
          ...
          <section id="conditions" className="mb-12 scroll-mt-24">
            ...
            <p className="mb-6 text-lg leading-relaxed">
              For a deadlock to occur, all four of these conditions must be
              present simultaneously. Breaking any one of them prevents
              deadlock.
            </p>
            ...
            <div className="space-y-4">
              ...
              >
                ...
                >
                  A set of threads exists where each thread is waiting for a
                  resource held by the next thread in the chain, forming a
                  circle.
                </p>
              </div>
            </div>
          ...
          <section id="example" className="mb-12 scroll-mt-24">
            ...
            <p className="mb-6 text-lg leading-relaxed">
              Let's look at a classic example where two threads try to acquire
              locks in different orders, resulting in a deadlock.
            </p>
            ...
            >
              ...
              <ol className="space-y-2 ml-6 list-decimal">
                ...
                <li>
                  Thread 1 tries to acquire lock2 (held by Thread 2) - BLOCKED
                </li>
                <li>
                  Thread 2 tries to acquire lock1 (held by Thread 1) - BLOCKED
                </li>
            ...
            >
              <div className="flex items-center gap-2 mb-3">
                ...
                <span className="font-semibold text-green-500">
                  Fixed Code - Always acquire locks in the same order
                </span>
              </div>
              <pre
                className={`p-4 rounded-lg overflow-x-auto ${
            ...
            <div className="space-y-4">
              {[
                ...
                },
                {
                  ...
                  text: "Use lock timeout mechanisms (tryLock) instead of indefinite waiting",
                },
                {
                  icon: <MdCheckCircle size={30} />,
                  text: "Minimize the scope of synchronized blocks to reduce lock holding time",
                },
                {
                  icon: <GiBreakingChain size={30} />,
                  text: "Avoid nested locks when possible - use higher-level concurrency utilities",
                },
                {
                  icon: <BiError size={30} />,
                  text: "Use thread dumps and profilers to detect and analyze deadlocks",
                },
                {
                  icon: <MdWarning size={30} />,
                  text: "Test concurrent code thoroughly with stress tests and race condition scenarios",
                },
              ].map((item, index) => (
                <div
                  key={index}
              ...
              >
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    >
                      Understand threading fundamentals in Java
                    </p>
                  </div>
                </div>
              </button>
