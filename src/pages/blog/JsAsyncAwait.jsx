        ...
        <div className="flex-1 max-w-4xl">
          ...
          <section className={`mb-12 rounded-2xl p-8 border ${
            ...
            <div className="flex items-start gap-4">
              ...
              <p className="text-lg leading-relaxed">
                Async/await is syntactic sugar built on top of Promises that makes asynchronous 
                code look and behave more like synchronous code, making it easier to read, 
                write, and maintain.
              </p>
            </div>
          </section>
          ...
          <section id="what-is" className="mb-12 scroll-mt-24">
            ...
            <p className="mb-6 text-lg leading-relaxed">
              Introduced in ES2017, async/await provides a cleaner syntax for working with 
              asynchronous operations. It allows you to write asynchronous code that reads 
          ...
          <section id="basics" className="mb-12 scroll-mt-24">
            ...
            <h3 className="text-xl font-semibold mb-4">Before: Promise Chains</h3>
            ...
            <div className={`rounded-xl p-6 mb-6 ${
              ...
              <div className="flex items-center gap-2 mb-3">
                ...
                <span className="font-semibold text-orange-500">Old Way - Promise Chains</span>
              </div>
            ...
            <div className={`rounded-xl p-6 mb-6 ${
              ...
              <div className="flex items-center gap-2 mb-3">
                ...
                <span className="font-semibold text-green-500">Modern Way - Async/Await</span>
              </div>
              <pre className={`p-4 rounded-lg overflow-x-auto ${
                theme === 'light'
                  ? 'bg-neutral-900 text-green-400'
          ...
          <section id="error-handling" className="mb-12 scroll-mt-24">
            ...
            <p className="mb-6 text-lg leading-relaxed">
              Proper error handling is crucial in async functions. Use try-catch blocks to 
            ...
            <div className={`rounded-xl p-6 mb-6 ${
              ...
              <div className="flex items-center gap-2 mb-3">
                ...
                <span className="font-semibold">Comprehensive Error Handling</span>
              </div>
              <pre className={`p-4 rounded-lg overflow-x-auto ${
                theme === 'light'
                  ? 'bg-neutral-900 text-green-400'
            ...
            <div className={`rounded-xl p-6 mb-6 ${
              ...
              <div className="flex items-center gap-2 mb-3">
                <MdCheckCircle className="text-green-500" size={24} />
                <span className="font-semibold text-green-500">Finally Block for Cleanup</span>
              </div>
              <pre className={`p-4 rounded-lg overflow-x-auto ${
                theme === 'light'
                  ? 'bg-neutral-900 text-green-400'
          ...
          <section id="best-practices" className="mb-12 scroll-mt-24">
            ...
            <h3 className="text-2xl font-semibold mb-4">1. Parallel Execution with Promise.all</h3>
            ...
            <div className={`rounded-xl p-6 mb-6 ${
              ...
              <div className="flex items-center gap-2 mb-3">
                <BiError className="text-red-500" size={24} />
                <span className="font-semibold text-red-500"> Slow - Sequential Execution</span>
              </div>
              <pre className={`p-4 rounded-lg overflow-x-auto ${
                theme === 'light'
                  ? 'bg-neutral-900 text-green-400'
                ...
                <code>{`// Takes 3 seconds total (1s + 1s + 1s)
            ...
            <div className={`rounded-xl p-6 mb-6 ${
              ...
              <div className="flex items-center gap-2 mb-3">
                ...
                <span className="font-semibold text-green-500"> Fast - Parallel Execution</span>
              </div>
              <pre className={`p-4 rounded-lg overflow-x-auto ${
                theme === 'light'
                  ? 'bg-neutral-900 text-green-400'
                ...
                <code>{`// Takes ~1 second total (all run in parallel)
                  async function fetchAllData() {
            ...
            <h3 className="text-2xl font-semibold mb-4 mt-8">2. Avoid Mixing Async/Await with .then()</h3>
            ...
            <div className={`rounded-xl p-6 mb-6 ${
              ...
              <div className="flex items-center gap-2 mb-3">
                ...
                <span className="font-semibold text-orange-500">Inconsistent - Mixed Style</span>
              </div>
              <pre className={`p-4 rounded-lg overflow-x-auto ${
                theme === 'light'
                  ? 'bg-neutral-900 text-green-400'
            ...
            <div className={`rounded-xl p-6 mb-6 ${
              ...
              <div className="flex items-center gap-2 mb-3">
                <MdCheckCircle className="text-green-500" size={24} />
                <span className="font-semibold text-green-500">Clean - Consistent Style</span>
              </div>
              <pre className={`p-4 rounded-lg overflow-x-auto ${
                theme === 'light'
                  ? 'bg-neutral-900 text-green-400'
...
async function consistentStyle() {
  ...
  return data;
            ...
            <h3 className="text-2xl font-semibold mb-4 mt-8">3. Top-Level Async Patterns</h3>
            ...
            <div className={`rounded-xl p-6 mb-6 ${
              ...
              <pre className={`p-4 rounded-lg overflow-x-auto ${
                ...
                <code>{`// Modern: Top-level await (ES2022+)
...
(async () => {
  ...
  console.log(json);
            ...
            <div className="space-y-4">
              {[
                { icon: <MdSpeed />, text: 'Use Promise.all() for parallel execution to improve performance' },
                { icon: <BiError />, text: 'Always wrap await calls in try-catch for proper error handling' },
                { icon: <GiChainedHeart />, text: 'Use finally blocks for cleanup code that must always run' },
                { icon: <FaCheckCircle />, text: 'Keep async/await style consistent - avoid mixing with .then()' },
                { icon: <MdCheckCircle />, text: 'Return Promises directly when you don\'t need to await' },
                { icon: <FaExclamationTriangle />, text: 'Be careful with await in loops - consider Promise.all() instead' }
              ].map((item, index) => (
                <div key={index} className={`flex items-start gap-4 p-4 border rounded-xl transition ${
                  ...
                  <span className="text-2xl flex-shrink-0 text-blue-500">{item.icon}</span>
          ...
          <footer className={`pt-8 border-t text-center ${
            ...
            <p className="text-sm mb-6">
              Master async/await to write cleaner, more maintainable JavaScript
            </p>
            <button
