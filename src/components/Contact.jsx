...
const Contact = () => {
  return <div id="#contact" className="flex-min-h-[70px] min-w-full items-center justify-center">
    <div className="flex flex-col items-center justify-center gap-3 space-y-6 p-14">
      ...
      <a href="mailto:t.ttan25204@gmail.com" className="text-nowrap rounded-lg  border border-indigo-600 bg-black px-5 
      py-3 text-lg font-bold text-white shadow-lg shadow-indigo-700 transition-all duration-300
